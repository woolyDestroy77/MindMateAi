/*
  ...
  2. Security
    ...
    - Adds policies for authenticated users to upload, update and delete their own files
*/
...
-- We use DO blocks to safely check if policies exist before creating them
