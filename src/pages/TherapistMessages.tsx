...
import { MessageSquare, Send, User, ArrowLeft, Phone, Video, Calendar, Clock, Shield, Award, Search, Filter, Plus, Mic, MicOff, Play, Pause, Smile, Heart, ThumbsUp, ThumbsDown, Laugh, Angry, Salad as Sad, MoreHorizontal, Check, CheckCheck, Paperclip, Image as ImageIcon, X, Loader2, Trash2 } from 'lucide-react';
                ...
                {targetUser && !conversations.find(c => c.id === targetUser.id) && (
                  <div className="border-b border-gray-100">
                    <button
                      ...
                      className={`w-full text-left p-4 hover:bg-gradient-to-r hover:from-lavender-50 hover:to-blue-50 transition-all duration-200 ${
                        selectedConversation === targetUser.id ? 'bg-gradient-to-r from-lavender-50 to-blue-50 border-r-4 border-lavender-500' : ''
                      }`}
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="font-semibold text-gray-900">{targetUser.name}</div>
                          <div className="text-sm text-gray-500">Start a new conversation</div>
                        </div>
                        <div className="text-xs bg-gradient-to-r from-blue-500 to-purple-500 text-white px-3 py-1 rounded-full font-medium">
                          New
                        </div>
                      </div>
                    </button>
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gradient-to-b from-blue-50/30 to-lavender-50/30">
                  {Object.keys(groupedMessages).length === 0 ? (
                    <div className="text-center py-12">
                      <div className="w-20 h-20 rounded-full bg-gradient-to-br from-lavender-100 to-blue-100 flex items-center justify-center mx-auto mb-4">
