...
export const useAIChat = () => {
  ...
  const sendMessage = useCallback(async (content: string) => {
    try {
      ...
      console.log("Sending message to Dappier AI Agent:", {
        message: content,
        context,
      });
      ...
      if (error) {
        ...
        if (
          ...
          toast.error(
            "AI service is temporarily busy due to high demand. Please wait a moment and try again.",
          );
        ...
        try {
          ...
          if (error.context?.body) {
            ...
            if (errorBody.error) {
              ...
              errorDetails = errorBody.details || errorBody.message ||
                errorDetails;
            }
          }
          ...
          switch (errorCode) {
            case "QUOTA_EXCEEDED":
              userMessage =
                "AI service has reached its usage limit. Please try again in a few minutes.";
              break;
          ...
          console.error("Dappier AI Agent error details:", {
            errorCode,
            errorDetails,
            originalError: error,
          });
          ...
          console.error(
            "Error parsing Edge Function error details:",
            parseError,
          );
      ...
      if (
        !errorMessage.includes("Dappier AI Agent error") &&
